...
function FixturePage() {
  ...
  const { enabled: notiEnabled, toggle: toggleNoti } = useMatchNotifications(allMatches, predByMatch);
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 sm:px-6">
      ...
      <div className="flex gap-2 mb-6">
        ...
        <button onClick={toggleNoti} title={notiEnabled ? "Desactivar recordatorios" : "Activar recordatorios 1h antes"}
