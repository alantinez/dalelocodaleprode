      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-center">
          ...
          <motion.div
            ...
            className="hidden lg:block w-52 flex-shrink-0 pointer-events-none select-none"
          >
            <div className="rounded-2xl overflow-hidden border-2 border-gold/40 shadow-glow rotate-2 hover:rotate-0 transition-transform duration-300">
